  ...
  INTEGER :: step, counter_2d, counter_3d, counter_1d, ksurf1, ksurf2, ksurf3, ksurf4, ksurf5, islice, jslice, imooring, jmooring, n
  REAL :: sigma,z
...
! out3d_int  - frequency of 3d output
 ...
 !  ksurf1=1   --- Z=-0.36 m    
    ksurf1=NK-1; call write_cdf_2D_sigma(ksurf1,counter_2d,n)
 !  ksurf2=60 --- Z= 20 m
    ksurf2=60;   call write_cdf_2D_sigma(ksurf2,counter_2d,n)
 !  ksurf3=53 --- Z= 60 m          
    ksurf3=53;   call write_cdf_2D_sigma(ksurf3,counter_2d,n)
 !  ksurf4=48 --- Z=-100 m     
    ksurf4=48;   call write_cdf_2D_sigma(ksurf4,counter_2d,n)
 !  ksurf5=18 --- Z=-500 m  
    ksurf5=18;   call write_cdf_2D_sigma(ksurf5,counter_2d,n)
...
! sigma=28.85d0; call write_cdf_2D_isopycnal(sigma,counter_2d,n) ! writes the solution on the sigma isopycnal
