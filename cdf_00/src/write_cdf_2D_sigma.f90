...
!-------INCLUDE '/sw/lib/netcdf-gfortran/include/netcdf.inc'             
        ...
        REAL(kind=4) :: xsurf(NI), ysurf(NJ), zsurf(NI,NJ), ssurf(NI,NJ),&
                        ...
                        & psurf(NI,NJ), pvsurf(NI,NJ), vorsurf(NI,NJ), &
                        & strainsurf(NI,NJ), n2surf(NI,NJ), nsq30m(NI,NJ), nsq100m(NI,NJ),&
                        & integcons(NI,NJ,nconsume), time_days                             
...
!                                          
        ...
        integer :: idvstrain, idvstressx, idvstressy, idvstr, idvs, idvtbar, idvtemp, idvtim, idvtr, idvt, idvu,&
                   & idvvb, idvvc, idvvor, idvv
...
!  dimstr(4) = ncddef(idDatFile,'time',NCUNLIM,rcode)            
                ...
                idvstressx = ncvdef(idDatFile,'stressx',NCDOUBLE,3,dims,rcode)
                idvstressy = ncvdef(idDatFile,'stressy',NCDOUBLE,3,dims,rcode)
...
!idvb = NCVID(idDatFile, 'integconsBBL', RCODE)                
        ...
        CALL ncvpt(idDatFile, idvstressx, start, count, stress_top_x, rcode)
        CALL ncvpt(idDatFile, idvstressy, start, count, stress_top_y, rcode) 
...
!       CALL ncvpt(idDatFile,idvb, starttr,counttr,integconsBBL,rcode)   
        ...
        return 
end subroutine write_cdf_2D_sigma
